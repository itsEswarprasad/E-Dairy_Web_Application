            ...
            <Hero>
                <Hero.Content className="flex-col lg:flex-row">
                    <div className="text-center space-y-7">
                        ...
                        <a className="space-y-7 text-sky-400 after:content-['_↗'] ..." href="tel:6300513147">6300513147</a><br></br>
                        <a className="space-y-7 text-sky-400 after:content-['_↗'] ..." href="mailto:itseswarprasad@gmail.com">itseswarprasad@gmail.com</a>
                        <p>
                            AP IIIT RGUKT RK VALLEY<br></br>
                            ANDHRA PRADESH
                        </p>
                    </div>
